...
export default function Checkout() {
  ...
  const isSwiss = ['schweiz','switzerland','suisse','svizzera','ch'].includes(formData.country.trim().toLowerCase()); const shipping = isSwiss ? SHIPPING_CH : SHIPPING_INT; const grandTotal = totalPrice + shipping;
